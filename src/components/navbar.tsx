  ...
  return (
    <motion.nav
      ...
      className={cn(
        ...
        scrolled ? "bg-white/90 shadow-lg backdrop-blur-md" : "bg-white/70 shadow-sm backdrop-blur-md"
      )}
    ...
    >
      <div className="w-full max-w-7xl flex h-16 items-center px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <Link 
          href="/" 
          className="font-extrabold text-lg sm:text-xl lg:text-2xl text-blue-800 flex items-center gap-1 sm:gap-2 select-none"
