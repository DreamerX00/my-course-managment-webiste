...
import { FOOTER_LINKS, COPYRIGHT_TEXT, NEWSLETTER_CONTENT } from "@/lib/constants"
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 mt-4">
              {FOOTER_LINKS.socials.map((social, index) => (
                <Link key={index} href={social.href} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-200">
