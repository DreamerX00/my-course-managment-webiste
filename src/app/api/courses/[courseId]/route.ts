      ...
      if (existingDetails) {
        ...
        await db.courseDetails.update({
          ...
          data: {
            ...
            isFree: price !== undefined ? (!price || price === 0) : existingDetails.isFree,
          }
        });
      } else {
        ...
        await db.courseDetails.create({
          data: {
            ...
            originalPrice: (price !== undefined ? price : (course.price || 0)) * 1.5,
            isFree: price !== undefined ? (!price || price === 0) : (!course.price || course.price === 0),
